...
**Therefore, Cosmos tries to enable interoperability among many sovereign blockchains, even if they have different governance policies. Social scalability is one of the core value props of Cosmos. It give its users and developers the ultimate freedom and potential for permissionless experimentation because they have the freedom to govern their network in the best way possible.**
