...
**Cosmos fundamentally believes that it's impossible to get everyone to agree on a single set of rules to govern a world-wide economic network. This is already evident in the real world where you see multiple forks of Bitcoin being created because of philosophical and political disagreement. On the other hand, in Ethereum's case, we're seeing that stakeholders can't agree** **on the right form of governance or have a tendency to resist formal governance, which can be** [counter-productive](https://twitter.com/iam_preethi/status/1112776792157220864) **and slow down the progress of development.**
